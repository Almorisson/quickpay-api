...
exports.register = async (req, res, next) => {
    try {
        ...
        //     customer.qrCode.data = fs.writeSync([req.body.iban, req.body.siretNumber, req.body.email]); // Appeler la fonction g�n�rer QRcode
...
//             return res.status(401).json({message: "Trader not found"})
//         }
//         //trader = await trader.select("firstName, lastName, iban, siretNumber, country, address") // s�lectionner les champs qu'on veut retourner
//         return res.send({trader})
//     } catch (err) {
//         next(err)
//     }
